                                                    ...
                                                    orientation_deplacement orientation)
{
  ...
  else if (plateau_modification_deplacer_piece_etre_possible(&(jeu->plateau),x,y,deplacement,orientation)==0)
    {
      Valid =0;
    }
...
coup_jeu api_siam_tenter_changer_orientation_piece_si_possible(jeu_siam* jeu,int x,int y,orientation_deplacement orientation)
{
  ...
  else if(plateau_exister_piece(&(jeu->plateau),x,y)==0){puts("2");Valid=0;} //On vérifie que la pièce existe sur ce plateau
  ...
  else if (plateau_modification_changer_orientation_piece_etre_possible(&(jeu->plateau),x,y,orientation)==0){puts("4");Valid =0;}
