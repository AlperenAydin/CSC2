 ...
 * *************************
 *    Verifie qu'une orientation correspond aux différentes valeurs (0,...4) possibles.
 *
 *    Necessite:
 ...
 * *************************
 *    Verifie que le caractere passe en parametre est 
 *    un des caracteres qui correspond a un deplacement.
 *    
 *
 *    Necessite:
 ...
 *    Garantie:
 *      - Le caractere correspond a un deplacement
 *         
 */
