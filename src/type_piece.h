 ...
 * *************************
 *    Verifie que type_etre_animal fonctionne correctement en l'utilisant sur chaque 
 *    type possible.
 *
 *    Necessite:
 *   
...
/**
 * Fonction test_type_correspond_caractere_animal:
 * *************************
 *    Verifie que type_correspond_caractere_animal fonctionne correctement .
 *
 *    Necessite:
 *   
 *    Garantie:
